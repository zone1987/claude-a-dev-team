...
Restructured from 96 skills into 8 domain skills. **Breaking:** every skill ID changed.

### Why

96 skills cost 38,573 characters of the skill listing budget — 482 % of the 8,000 available at a
...
- **96 skills → 8**, grouped by domain. Listing cost 38,573 → 2,265 characters
  (482 % → 28 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 442 reference files remain.
...
Initial release — 96 skills, one per documentation topic.
