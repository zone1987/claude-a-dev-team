...
- [Demo (with dropdown for collapsed items)](#demo-with-dropdown-for-collapsed-items)
- [With custom separator (slash)](#with-custom-separator-slash)
- [Collapsed with ellipsis](#collapsed-with-ellipsis)
- [With dropdown on a segment](#with-dropdown-on-a-segment)
