...
- [Example 1 — Demo (Edit Profile)](#example-1-demo-edit-profile)
- [Example 2 — Custom Close Button](#example-2-custom-close-button)
- [Example 3 — No Close Button](#example-3-no-close-button)
- [Example 4 — Dialog from Dropdown Menu](#example-4-dialog-from-dropdown-menu)
