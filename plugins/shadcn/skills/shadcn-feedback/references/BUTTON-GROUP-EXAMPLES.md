...
- [Demo (email toolbar with nested groups)](#demo-email-toolbar-with-nested-groups)
- [Orientation (vertical)](#orientation-vertical)
- [Separator (split button)](#separator-split-button)
- [With input](#with-input)
- [With dropdown (split button pattern)](#with-dropdown-split-button-pattern)
