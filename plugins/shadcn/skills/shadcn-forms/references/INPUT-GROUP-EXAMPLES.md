...
- [Example 1 — Demo (Multi-pattern Showcase)](#example-1-demo-multi-pattern-showcase)
- [Example 2 — Simple Icon Start](#example-2-simple-icon-start)
- [Example 3 — Text Prefix + Icon End](#example-3-text-prefix-icon-end)
- [Example 4 — Textarea with Block-end Submit Button](#example-4-textarea-with-block-end-submit-button)
