...
- [Example 1 — Demo (6 slots, 2 groups)](#example-1-demo-6-slots-2-groups)
- [Example 2 — Separator (3 groups of 2)](#example-2-separator-3-groups-of-2)
- [Example 3 — Controlled](#example-3-controlled)
- [Example 4 — Alphanumeric Pattern](#example-4-alphanumeric-pattern)
