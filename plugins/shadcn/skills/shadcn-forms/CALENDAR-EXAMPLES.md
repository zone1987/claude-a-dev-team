...
- [Demo (with dropdown caption)](#demo-with-dropdown-caption)
- [Basic (label caption)](#basic-label-caption)
- [Range selection](#range-selection)
- [With timezone (SSR-safe)](#with-timezone-ssr-safe)
- [Custom cell size (responsive)](#custom-cell-size-responsive)
- [Persian / Hijri calendar](#persian-hijri-calendar)
- [RTL with Arabic locale](#rtl-with-arabic-locale)
