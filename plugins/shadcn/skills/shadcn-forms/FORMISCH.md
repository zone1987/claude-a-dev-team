...
- [Setup](#setup)
- [Full form pattern](#full-form-pattern)
- [Error display pattern](#error-display-pattern)
- [Validation modes](#validation-modes)
- [Binding to controls](#binding-to-controls)
- [Field types](#field-types)
- [Array fields (FieldArray)](#array-fields-fieldarray)
- [Form reset](#form-reset)
- [Top-level API shape](#top-level-api-shape)
