...
- [Bar Chart — Basic](#bar-chart-basic)
- [Bar Chart — Grid](#bar-chart-grid)
- [Bar Chart — Axis](#bar-chart-axis)
- [Bar Chart — Tooltip](#bar-chart-tooltip)
- [Bar Chart — Legend](#bar-chart-legend)
- [Tooltip Demo](#tooltip-demo)

## Bar Chart — Basic

Minimal bar chart with two data keys and `ChartContainer`. No grid, no axis, no tooltip.
...
Bar chart with a `CartesianGrid` showing only horizontal lines.
...
Bar chart with grid and an `XAxis` that abbreviates month names to 3 characters.
...
Bar chart with grid, axis, and `ChartTooltip` using `ChartTooltipContent`.
...
Full bar chart with grid, axis, tooltip, and `ChartLegend` using `ChartLegendContent`.
...
Visual demonstration of the `ChartTooltipContent` component showing label, name, and indicator variants (dot, line, dashed) rendered as static tooltips without a chart.
...
_Sources: `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-bar-demo.tsx`, `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-bar-demo-grid.tsx`, `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-bar-demo-axis.tsx`, `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-bar-demo-tooltip.tsx`, `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-bar-demo-legend.tsx`, `/tmp/shadcn-repo/apps/v4/registry/new-york-v4/examples/chart-tooltip-demo.tsx`_
