...
- [1. chart-tooltip-default – Default ChartTooltipContent](#1-chart-tooltip-default-default-charttooltipcontent)
- [2. chart-tooltip-advanced – Custom formatter with total row](#2-chart-tooltip-advanced-custom-formatter-with-total-row)
- [3. chart-tooltip-formatter – Simple formatter with kcal unit](#3-chart-tooltip-formatter-simple-formatter-with-kcal-unit)
- [4. chart-tooltip-icons – ChartConfig with lucide icon field](#4-chart-tooltip-icons-chartconfig-with-lucide-icon-field)
- [5. chart-tooltip-indicator-line – Line indicator style](#5-chart-tooltip-indicator-line-line-indicator-style)
