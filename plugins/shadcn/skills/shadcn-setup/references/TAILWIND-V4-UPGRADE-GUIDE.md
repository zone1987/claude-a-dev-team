...
- [Step 1 — Follow the Tailwind v4 Upgrade Guide](#step-1-follow-the-tailwind-v4-upgrade-guide)
- [Step 2 — Update CSS variables](#step-2-update-css-variables)
- [Step 3 — Update chart colors](#step-3-update-chart-colors)
- [Step 4 — Use new size-* utility](#step-4-use-new-size--utility)
- [Step 5 — Update dependencies](#step-5-update-dependencies)
- [Step 6 — Remove forwardRef](#step-6-remove-forwardref)
