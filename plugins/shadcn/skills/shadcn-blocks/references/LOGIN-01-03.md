...
Simple centered card with email, password, Google login button.
...
Two-column layout: form on left, hero image on right (hidden on mobile). GitHub social login.

**Install:** `npx shadcn@latest add login-02`
...
Muted background, centered card, social buttons (Apple + Google) at top, then email/password form.

**Install:** `npx shadcn@latest add login-03`
