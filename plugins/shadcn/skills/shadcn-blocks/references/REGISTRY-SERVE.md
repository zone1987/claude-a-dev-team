...
- [Option A: Static JSON files (shadcn build)](#option-a-static-json-files-shadcn-build)
- [Option B: Dynamic route handlers (shadcn/registry)](#option-b-dynamic-route-handlers-shadcnregistry)
- [Content negotiation (root hosting)](#content-negotiation-root-hosting)
