...
- [registry:style (extending shadcn/ui)](#registrystyle-extending-shadcnui)
- [registry:style (from scratch, extends: none)](#registrystyle-from-scratch-extends-none)
- [registry:theme](#registrytheme)
- [registry:block](#registryblock)
- [registry:ui (with CSS vars)](#registryui-with-css-vars)
- [registry:lib](#registrylib)
- [registry:hook](#registryhook)
- [registry:font](#registryfont)
- [registry:base](#registrybase)
- [registry:item (universal, no framework detection needed)](#registryitem-universal-no-framework-detection-needed)
- [CSS: animations (keyframes + cssVars.theme)](#css-animations-keyframes-cssvarstheme)
- [CSS: Tailwind plugins](#css-tailwind-plugins)
