...
- [Basic configuration (URL template)](#basic-configuration-url-template)
- [Advanced configuration (with auth)](#advanced-configuration-with-auth)
- [CLI commands for namespaces](#cli-commands-for-namespaces)
- [Namespace vs GitHub registry](#namespace-vs-github-registry)
- [Dependency resolution](#dependency-resolution)
- [Organizing multiple registries](#organizing-multiple-registries)
