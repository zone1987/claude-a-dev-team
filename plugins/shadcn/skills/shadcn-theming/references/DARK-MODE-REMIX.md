...
- [Step 1 — Modify tailwind.css](#step-1-modify-tailwindcss)
- [Step 2 — Install remix-themes](#step-2-install-remix-themes)
- [Step 3 — Create session storage and resolver](#step-3-create-session-storage-and-resolver)
- [Step 4 — Set up Remix Themes in root.tsx](#step-4-set-up-remix-themes-in-roottsx)
- [Step 5 — Create action route](#step-5-create-action-route)
- [Step 6 — Mode toggle](#step-6-mode-toggle)
