...
Create `components/ui/scroll-area.tsx` with the source from [source.md](SCROLL-AREA-SOURCE.md).
...
### 2. Use base variant source from [source.md](SCROLL-AREA-SOURCE.md).
