...
- [Demo (default horizontal with nested vertical)](#demo-default-horizontal-with-nested-vertical)
- [Demo with Handle (visible grip)](#demo-with-handle-visible-grip)
- [Handle Only (sidebar + content)](#handle-only-sidebar-content)
- [Vertical](#vertical)
