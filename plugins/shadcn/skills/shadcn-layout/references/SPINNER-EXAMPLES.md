...
- [Basic (standalone)](#basic-standalone)
- [Demo (in item context)](#demo-in-item-context)
- [Size variants](#size-variants)
- [In a Button (loading state)](#in-a-button-loading-state)
- [In a Badge](#in-a-badge)
- [Color variants](#color-variants)
- [Custom icon](#custom-icon)
- [In an Input Group](#in-an-input-group)
- [In an Empty state](#in-an-empty-state)
- [In an Item with progress](#in-an-item-with-progress)
