...
- [Einstiegspunkte (via theme.json)](#einstiegspunkte-via-themejson)
- [abstract/ — Funktionen, Mixins, Variablen (Framework-Ebene)](#abstract-funktionen-mixins-variablen-framework-ebene)
- [base/ — Globale Basis-Styles](#base-globale-basis-styles)
- [component/ — UI-Komponenten (strukturell, skin-neutral)](#component-ui-komponenten-strukturell-skin-neutral)
- [layout/ — Seitenlayout-Bereiche](#layout-seitenlayout-bereiche)
- [page/ — Seitenspezifische Styles](#page-seitenspezifische-styles)
- [vendor/ — Externe Abhängigkeiten](#vendor-externe-abhängigkeiten)
- [skin/shopware/ — Shopware Default Visual Skin](#skinshopware-shopware-default-visual-skin)
- [Admin-SCSS (Abgrenzung)](#admin-scss-abgrenzung)
