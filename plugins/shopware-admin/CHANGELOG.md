...
Restructured from 29 skills into 4 domain skills. **Breaking:** every skill ID changed.

### Why

29 skills cost 13,872 characters of the skill listing budget — 173 % of the 8,000 available at a
...
- **29 skills → 4**, grouped by domain. Listing cost 13,872 → 1,191 characters
  (173 % → 15 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 39 reference files and 1 bundled files remain.
...
Initial release — 29 skills, one per documentation topic.
