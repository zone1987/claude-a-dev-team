<!-- generated by scripts/build_rest_reference.py from resources__audit-log.md sha256:908d278721d0 — do not edit by hand -->

# Discord REST: Audit Logs Resource

Reference for Discord audit log objects and endpoints.

Source: [https://docs.discord.com/developers/resources/audit-log](https://docs.discord.com/developers/resources/audit-log) — retrieved 2026-08-26.
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------- |
| application\_commands    | array of [application commands](https://docs.discord.com/developers/interactions/application-commands#application-command-object) objects  | List of application commands referenced in the audit log    |
| audit\_log\_entries      | array of audit log entry objects                         | List of audit log entries, sorted from most to least recent |
| auto\_moderation\_rules  | array of [auto moderation rule](AUTO-MODERATION.md) objects         | List of auto moderation rules referenced in the audit log   |
| guild\_scheduled\_events | array of [guild scheduled event](GUILD-SCHEDULED-EVENT.md) objects | List of guild scheduled events referenced in the audit log  |
| integrations             | array of partial [integration](GUILD.md) objects                             | List of partial integration objects                         |
| threads                  | array of thread-specific [channel](CHANNEL.md) objects                           | List of threads referenced in the audit log\*               |
| users                    | array of [user](USER.md) objects                                                    | List of users referenced in the audit log                   |
| webhooks                 | array of [webhook](WEBHOOK.md) objects                                           | List of webhooks referenced in the audit log                |
...
| changes?     | array of audit log change objects                  | Changes made to the target\_id                        |
| user\_id     | ?snowflake                                                                                                    | User or app that made the changes                     |
| id           | snowflake                                                                                                     | ID of the entry                                       |
| action\_type | audit log event                    | Type of action that occurred                          |
...
| ----------------------------------------------- | ----- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| GUILD\_UPDATE                                   | 1     | Server settings were updated                              | [Guild](GUILD.md)                                                                                                      |
| CHANNEL\_CREATE                                 | 10    | Channel was created                                       | [Channel](CHANNEL.md)                                                                                                |
| CHANNEL\_UPDATE                                 | 11    | Channel settings were updated                             | [Channel](CHANNEL.md)                                                                                                |
| CHANNEL\_DELETE                                 | 12    | Channel was deleted                                       | [Channel](CHANNEL.md)                                                                                                |
| CHANNEL\_OVERWRITE\_CREATE                      | 13    | Permission overwrite was added to a channel               | [Channel Overwrite](CHANNEL.md)                                                                                    |
| CHANNEL\_OVERWRITE\_UPDATE                      | 14    | Permission overwrite was updated for a channel            | [Channel Overwrite](CHANNEL.md)                                                                                    |
| CHANNEL\_OVERWRITE\_DELETE                      | 15    | Permission overwrite was deleted from a channel           | [Channel Overwrite](CHANNEL.md)                                                                                    |
...
| MEMBER\_UPDATE                                  | 24    | Member was updated in server                              | [Member](GUILD.md)                                                                                              |
| MEMBER\_ROLE\_UPDATE                            | 25    | Member was added or removed from a role                   | [Partial Role](https://docs.discord.com/developers/topics/permissions#role-object)\*                                                                                           |
...
| ROLE\_CREATE                                    | 30    | Role was created                                          | [Role](https://docs.discord.com/developers/topics/permissions#role-object)                                                                                                     |
| ROLE\_UPDATE                                    | 31    | Role was edited                                           | [Role](https://docs.discord.com/developers/topics/permissions#role-object)                                                                                                     |
| ROLE\_DELETE                                    | 32    | Role was deleted                                          | [Role](https://docs.discord.com/developers/topics/permissions#role-object)                                                                                                     |
| INVITE\_CREATE                                  | 40    | Server invite was created                                 | [Invite](INVITE.md) and [Invite Metadata](INVITE.md)\*                      |
| INVITE\_UPDATE                                  | 41    | Server invite was updated                                 | [Invite](INVITE.md) and [Invite Metadata](INVITE.md)\*                      |
| INVITE\_DELETE                                  | 42    | Server invite was deleted                                 | [Invite](INVITE.md) and [Invite Metadata](INVITE.md)\*                      |
| WEBHOOK\_CREATE                                 | 50    | Webhook was created                                       | [Webhook](WEBHOOK.md)\*                                                                                              |
| WEBHOOK\_UPDATE                                 | 51    | Webhook properties or channel were updated                | [Webhook](WEBHOOK.md)\*                                                                                              |
| WEBHOOK\_DELETE                                 | 52    | Webhook was deleted                                       | [Webhook](WEBHOOK.md)\*                                                                                              |
| EMOJI\_CREATE                                   | 60    | Emoji was created                                         | [Emoji](EMOJI.md)                                                                                                      |
| EMOJI\_UPDATE                                   | 61    | Emoji name was updated                                    | [Emoji](EMOJI.md)                                                                                                      |
| EMOJI\_DELETE                                   | 62    | Emoji was deleted                                         | [Emoji](EMOJI.md)                                                                                                      |
...
| INTEGRATION\_CREATE                             | 80    | App was added to server                                   | [Integration](GUILD.md)                                                                                          |
| INTEGRATION\_UPDATE                             | 81    | App was updated (as an example, its scopes were updated)  | [Integration](GUILD.md)                                                                                          |
| INTEGRATION\_DELETE                             | 82    | App was removed from server                               | [Integration](GUILD.md)                                                                                          |
| STAGE\_INSTANCE\_CREATE                         | 83    | Stage instance was created (stage channel becomes live)   | [Stage Instance](STAGE-INSTANCE.md)                                                                           |
| STAGE\_INSTANCE\_UPDATE                         | 84    | Stage instance details were updated                       | [Stage Instance](STAGE-INSTANCE.md)                                                                           |
| STAGE\_INSTANCE\_DELETE                         | 85    | Stage instance was deleted (stage channel no longer live) | [Stage Instance](STAGE-INSTANCE.md)                                                                           |
| STICKER\_CREATE                                 | 90    | Sticker was created                                       | [Sticker](STICKER.md)                                                                                                |
| STICKER\_UPDATE                                 | 91    | Sticker details were updated                              | [Sticker](STICKER.md)                                                                                                |
| STICKER\_DELETE                                 | 92    | Sticker was deleted                                       | [Sticker](STICKER.md)                                                                                                |
| GUILD\_SCHEDULED\_EVENT\_CREATE                 | 100   | Event was created                                         | [Guild Scheduled Event](GUILD-SCHEDULED-EVENT.md)                                                      |
| GUILD\_SCHEDULED\_EVENT\_UPDATE                 | 101   | Event was updated                                         | [Guild Scheduled Event](GUILD-SCHEDULED-EVENT.md)                                                      |
| GUILD\_SCHEDULED\_EVENT\_DELETE                 | 102   | Event was cancelled                                       | [Guild Scheduled Event](GUILD-SCHEDULED-EVENT.md)                                                      |
| THREAD\_CREATE                                  | 110   | Thread was created in a channel                           | [Thread](CHANNEL.md)                                                                                         |
| THREAD\_UPDATE                                  | 111   | Thread was updated                                        | [Thread](CHANNEL.md)                                                                                         |
| THREAD\_DELETE                                  | 112   | Thread was deleted                                        | [Thread](CHANNEL.md)                                                                                         |
| APPLICATION\_COMMAND\_PERMISSION\_UPDATE        | 121   | Permissions were updated for a command                    | [Command Permission](https://docs.discord.com/developers/interactions/application-commands#application-command-permissions-object-application-command-permissions-structure)\* |
| SOUNDBOARD\_SOUND\_CREATE                       | 130   | Soundboard sound was created                              | [Soundboard Sound](SOUNDBOARD.md)                                                                           |
| SOUNDBOARD\_SOUND\_UPDATE                       | 131   | Soundboard sound was updated                              | [Soundboard Sound](SOUNDBOARD.md)                                                                           |
| SOUNDBOARD\_SOUND\_DELETE                       | 132   | Soundboard sound was deleted                              | [Soundboard Sound](SOUNDBOARD.md)                                                                           |
| AUTO\_MODERATION\_RULE\_CREATE                  | 140   | Auto Moderation rule was created                          | [Auto Moderation Rule](AUTO-MODERATION.md)                                                              |
| AUTO\_MODERATION\_RULE\_UPDATE                  | 141   | Auto Moderation rule was updated                          | [Auto Moderation Rule](AUTO-MODERATION.md)                                                              |
| AUTO\_MODERATION\_RULE\_DELETE                  | 142   | Auto Moderation rule was deleted                          | [Auto Moderation Rule](AUTO-MODERATION.md)                                                              |
...
| ONBOARDING\_PROMPT\_CREATE                      | 163   | Guild Onboarding Question was created                     | [Onboarding Prompt Structure](GUILD.md)                                         |
| ONBOARDING\_PROMPT\_UPDATE                      | 164   | Guild Onboarding Question was updated                     | [Onboarding Prompt Structure](GUILD.md)                                         |
| ONBOARDING\_PROMPT\_DELETE                      | 165   | Guild Onboarding Question was deleted                     | [Onboarding Prompt Structure](GUILD.md)                                         |
| ONBOARDING\_CREATE                              | 166   | Guild Onboarding was created                              | [Guild Onboarding](GUILD.md)                                                                                |
| ONBOARDING\_UPDATE                              | 167   | Guild Onboarding was updated                              | [Guild Onboarding](GUILD.md)                                                                                |
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Command Permission](https://docs.discord.com/developers/interactions/application-commands#application-command-permissions-object-application-command-permissions-structure) | snowflake as key                                               | The `changes` array contains objects with a `key` field representing the entity whose command was affected (role, channel, or user ID), a previous permissions object (with an `old_value` key), and an updated permissions object (with a `new_value` key) |
| [Invite](INVITE.md) and [Invite Metadata](INVITE.md)                      | Additional `channel_id` key (instead of object's `channel.id`) |                                                                                                                                                                                                                                                             |
| [Partial Role](https://docs.discord.com/developers/topics/permissions#role-object)                                                                                           | `$add` and `$remove` as keys                                   | `new_value` is an array of objects that contain the role `id` and `name`                                                                                                                                                                                    |
| [Webhook](WEBHOOK.md)                                                                                              | `avatar_hash` key (instead of `avatar`)                        |                                                                                                                                                                                                                                                             |

## Get Guild Audit Log

### GET /guilds/{guild.id}/audit-logs

Returns an audit log object for the guild. Requires the [`VIEW_AUDIT_LOG`](https://docs.discord.com/developers/topics/permissions#permissions-bitwise-permission-flags) permission.
...
| action\_type? | integer   | Entries for a specific audit log event |
