<!-- generated by scripts/build_rest_reference.py from resources__invite.md sha256:1cf2132cb238 — do not edit by hand -->

# Discord REST: Invite Resource

Source: [https://docs.discord.com/developers/resources/invite](https://docs.discord.com/developers/resources/invite) — retrieved 2026-08-26.

## Contents

- [Get Invite](#get-invite)
- [Delete Invite](#delete-invite)
- [Get Target Users](#get-target-users)
- [Update Target Users](#update-target-users)
- [Get Target Users Job Status](#get-target-users-job-status)
...
| guild?                        | partial [guild](GUILD.md) object                                         | the guild this invite is for                                                                                       |
| channel                       | ?partial [channel](CHANNEL.md) object                                  | the channel this invite is for                                                                                     |
| inviter?                      | [user](USER.md) object                                                    | the user who created the invite                                                                                    |
| target\_type?                 | integer                                                                                                  | the type of target for this voice channel invite |
| target\_user?                 | [user](USER.md) object                                                    | the user whose stream to display for this voice channel stream invite                                              |
| target\_application?          | partial [application](APPLICATION.md) object                       | the embedded application to open for this voice channel embedded application invite                                |
...
| guild\_scheduled\_event?      | [guild scheduled event](GUILD-SCHEDULED-EVENT.md) object | guild scheduled event data, only included if `guild_scheduled_event_id` contains a valid guild scheduled event id  |
| flags?                        | integer                                                                                                  | guild invite flags for guild invites              |
| roles?\*                      | array of partial [role](https://docs.discord.com/developers/topics/permissions#role-object) objects                              | the roles assigned to the user upon accepting the invite.                                                          |
...
| Field              | Type                                                                                     | Description                                        |
| ------------------ | ---------------------------------------------------------------------------------------- | -------------------------------------------------- |
| members            | array of partial [guild member](GUILD.md) objects | the members speaking in the Stage                  |
...
| Field                        | Type                                                   | Description                                                 |
| ---------------------------- | ------------------------------------------------------ | ----------------------------------------------------------- |
| with\_counts?                | [boolean](https://docs.discord.com/developers/reference#boolean-query-strings) | whether the invite should contain approximate member counts |
...
Delete an invite. Requires the `MANAGE_CHANNELS` permission on the channel this invite belongs to, or `MANAGE_GUILD` to remove any invite across the guild. Returns an invite object on success. Fires an [Invite Delete](https://docs.discord.com/developers/events/gateway-events#invite-delete) Gateway event.
...
Gets the users allowed to see and accept this invite. Response is a CSV file with the header `user_id` and each user ID from the original file passed to [invite create](CHANNEL.md) on its own line. Requires the caller to be the inviter, or have `MANAGE_GUILD` permission, or have `VIEW_AUDIT_LOG` permission.
