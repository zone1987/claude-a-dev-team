<!-- generated by scripts/build_rest_reference.py from resources__voice.md sha256:139d8d7f0d1b — do not edit by hand -->

# Discord REST: Voice Resource

Reference for Discord voice objects and connection endpoints.

Source: [https://docs.discord.com/developers/resources/voice](https://docs.discord.com/developers/resources/voice) — retrieved 2026-08-26.

## Contents

- [List Voice Regions](#list-voice-regions)
- [Get Current User Voice State](#get-current-user-voice-state)
- [Get User Voice State](#get-user-voice-state)
...
| member?                       | [guild member](GUILD.md) object | the guild member this voice state is for          |
...
Returns an array of voice region objects that can be used when setting a voice or stage channel's [`rtc_region`](CHANNEL.md).
...
Updates the current user's voice state. Returns `204 No Content` on success. Fires a [Voice State Update](https://docs.discord.com/developers/events/gateway-events#voice-state-update) Gateway event.
...
Updates another user's voice state. Returns `204 No Content` on success. Fires a [Voice State Update](https://docs.discord.com/developers/events/gateway-events#voice-state-update) Gateway event.
