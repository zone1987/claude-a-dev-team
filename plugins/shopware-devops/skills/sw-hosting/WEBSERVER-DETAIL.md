...
- [Recommended web servers](#recommended-web-servers)
- [HTTP cache enable](#http-cache-enable)
- [Varnish XKey (recommended, Shopware ≥ 6.6)](#varnish-xkey-recommended-shopware-66)
- [Fastly (since 6.4.11.0)](#fastly-since-64110)
- [HTTP Caching Policies (experimental, since CACHE_REWORK feature flag)](#http-caching-policies-experimental-since-cache_rework-feature-flag)
- [Cache commands](#cache-commands)
- [Logged-in / cart-filled cache bypass](#logged-in-cart-filled-cache-bypass)
- [CDN for assets](#cdn-for-assets)
