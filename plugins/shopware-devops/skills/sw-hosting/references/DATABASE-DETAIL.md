...
- [MySQL / MariaDB Requirements](#mysql-mariadb-requirements)
- [Database cluster](#database-cluster)
- [Reconnect for long-running environments (FrankenPHP worker mode)](#reconnect-for-long-running-environments-frankenphp-worker-mode)
- [Redis Overview](#redis-overview)
- [Redis data categories](#redis-data-categories)
- [Named Redis connections (since 6.6.8.0)](#named-redis-connections-since-6680)
- [Connection pooling (persistent connections)](#connection-pooling-persistent-connections)
- [Redis cluster settings](#redis-cluster-settings)
- [Recommended 5-Redis setup (cluster production)](#recommended-5-redis-setup-cluster-production)
- [PHP Redis extension](#php-redis-extension)
- [Redis SSL/TLS](#redis-ssltls)
