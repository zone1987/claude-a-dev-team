...
- [Custom index settings (since 6.4.12.0)](#custom-index-settings-since-64120)
- [N-gram search tuning](#n-gram-search-tuning)
- [Admin search (since 6.4.19.0)](#admin-search-since-64190)
- [ES/OS error handling](#esos-error-handling)
- [Cluster architecture](#cluster-architecture)
- [Configuration file (elasticsearch.yml)](#configuration-file-elasticsearchyml)
- [Search configuration note](#search-configuration-note)
