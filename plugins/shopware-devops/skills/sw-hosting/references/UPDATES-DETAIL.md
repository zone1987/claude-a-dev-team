...
- [Web updater](#web-updater)
- [Extension developer tools](#extension-developer-tools)
- [Security patches without upgrading](#security-patches-without-upgrading)
- [Disable auto-update (cluster/production)](#disable-auto-update-clusterproduction)
