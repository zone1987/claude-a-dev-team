...
- [Dockerfile (multi-stage with FrankenPHP)](#dockerfile-multi-stage-with-frankenphp)
- [Available Docker tags](#available-docker-tags)
- [Default PHP extensions in Docker image](#default-php-extensions-in-docker-image)
- [Docker environment variables](#docker-environment-variables)
- [Docker volumes (local storage)](#docker-volumes-local-storage)
- [Docker Compose example](#docker-compose-example)
- [Custom PHP extensions](#custom-php-extensions)
- [Custom Nginx config in container](#custom-nginx-config-in-container)
- [Extension management via Composer](#extension-management-via-composer)
- [Enable authoritative class map (all plugins via Composer)](#enable-authoritative-class-map-all-plugins-via-composer)
- [Disable runtime extension management (cluster)](#disable-runtime-extension-management-cluster)
- [Composer plugin loader](#composer-plugin-loader)
- [Health Check](#health-check)
- [Nginx client_max_body_size adjustment](#nginx-client_max_body_size-adjustment)
