...
- [YAML anchors to avoid duplication](#yaml-anchors-to-avoid-duplication)
- [Private files](#private-files)
- [Private file download strategies](#private-file-download-strategies)
- [Allowed file extensions](#allowed-file-extensions)
- [CDN configuration](#cdn-configuration)
- [Fallback behavior](#fallback-behavior)
- [Custom S3 HTTP client (since 6.7.9.0)](#custom-s3-http-client-since-6790)
- [Custom Flysystem adapter](#custom-flysystem-adapter)
