...
- [systemd setup (3 instances)](#systemd-setup-3-instances)
- [Supervisord](#supervisord)
- [Admin Worker config](#admin-worker-config)
- [Mail via message queue](#mail-via-message-queue)
- [Transport configuration](#transport-configuration)
- [Failed messages](#failed-messages)
- [Worker count](#worker-count)
- [Scheduled Tasks](#scheduled-tasks)
- [Disable scheduled sitemap (since 6.7.1.0)](#disable-scheduled-sitemap-since-6710)
