...
33 skills cost 18,516 characters of the skill listing budget — 231 % of the 8,000 available at a
...
- **33 skills → 4**, grouped by domain. Listing cost 18,516 → 1,153 characters
  (231 % → 14 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 66 reference files remain.
