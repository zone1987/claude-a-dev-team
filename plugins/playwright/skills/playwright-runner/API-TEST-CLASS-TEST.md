...
- [1. Declaring a Test](#1-declaring-a-test)
- [2. Hooks](#2-hooks)
- [3. Modifiers — Annotations](#3-modifiers-annotations)
- [4. Focus Modifiers](#4-focus-modifiers)
- [5. Test Organization — `test.describe`](#5-test-organization-testdescribe)
- [6. Steps](#6-steps)
- [7. Fixtures & Options](#7-fixtures-options)
