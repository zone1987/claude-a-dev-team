...
Restructured from 35 skills into 5 domain skills. **Breaking:** every skill ID changed.

### Why

35 skills cost 18,693 characters of the skill listing budget — 234 % of the 8,000 available at a
...
- **35 skills → 5**, grouped by domain. Listing cost 18,693 → 1,463 characters
  (234 % → 18 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 150 reference files remain.
...
Initial release — 35 skills, one per documentation topic.
