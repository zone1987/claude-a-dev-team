...
**Description:** OTP form in a two-column card layout with an image panel and a ToS note.
...
**Description:** Minimalist OTP form without a card, with a logo on top, extra-large slots (h-16 w-12) and a ToS note.
