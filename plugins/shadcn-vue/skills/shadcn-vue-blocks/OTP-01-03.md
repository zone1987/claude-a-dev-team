...
**Description:** Simple OTP verification form, centered inside a card.
...
**Description:** OTP form with a split-screen layout — form on the left, placeholder image on the right (from lg).
...
**Description:** OTP form with a muted background, logo on top, card with a centered header.
