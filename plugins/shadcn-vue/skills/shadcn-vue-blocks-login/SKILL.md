---
name: shadcn-vue-blocks-login
description: >
  shadcn-vue Login-Blocks (login-01 bis login-05) — fertige Login-Seiten mit Email/Passwort,
  Social-Auth, Cover-Image, Card-Layout. Triggers: "shadcn-vue login block", "shadcn vue login",
  "login page vue", "login form block", "shadcn login template", "anmeldeseite vue shadcn",
  "login mit google vue", "login mit github vue", "login zwei spalten vue"
---
...
- [`references/login-01-02.md`](references/login-01-02.md) — Vollständiger Code für login-01 und login-02
- [`references/login-03-04.md`](references/login-03-04.md) — Vollständiger Code für login-03 und login-04
- [`references/login-05.md`](references/login-05.md) — Vollständiger Code für login-05
