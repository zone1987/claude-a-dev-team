...
- `BREADCRUMB-INSTALLATION.md` — CLI and manual installation steps
- `BREADCRUMB-SOURCE.md` — Complete Vue source code for all 7 component files + index.ts
- `BREADCRUMB-API.md` — Props, accessibility attributes, and asChild notes per sub-component
- `BREADCRUMB-EXAMPLES.md` — All demo examples with full code (basic, dropdown, custom links)
