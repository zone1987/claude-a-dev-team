...
- [1. Inline Command (no dialog)](#1-inline-command-no-dialog)
- [2. CommandBasic (dialog-based)](#2-commandbasic-dialog-based)
- [3. CommandWithShortcuts](#3-commandwithshortcuts)
- [4. CommandWithGroups](#4-commandwithgroups)
- [Notes](#notes)
