...
- `BADGE-INSTALLATION.md` — CLI and manual installation steps
- `BADGE-SOURCE.md` — Full source of `index.ts` and `Badge.vue`
- `BADGE-API.md` — Props, variants, inherited Primitive props
- `BADGE-EXAMPLES.md` — Practical code examples
