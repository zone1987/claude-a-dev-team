...
- `ALERT-DIALOG-INSTALLATION.md` — CLI and manual installation steps
- `ALERT-DIALOG-SOURCE.md` — Complete Vue source code for all 9 component files + index.ts
- `ALERT-DIALOG-API.md` — Props, emits, slots per component; notes on buttonVariants usage
- `ALERT-DIALOG-EXAMPLES.md` — Core examples: basic, small, destructive, nested in Dialog
