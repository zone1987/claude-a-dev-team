...
- [`index.ts`](#indexts)
- [`Tooltip.vue`](#tooltipvue)
- [`TooltipContent.vue`](#tooltipcontentvue)
- [`TooltipProvider.vue`](#tooltipprovidervue)
- [`TooltipTrigger.vue`](#tooltiptriggervue)
...
**Source:** `registry/new-york-v4/ui/tooltip/Tooltip.vue`, `TooltipContent.vue`, `TooltipProvider.vue`, `TooltipTrigger.vue`, `index.ts`
