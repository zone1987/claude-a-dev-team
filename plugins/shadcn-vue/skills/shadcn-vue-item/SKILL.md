---
name: shadcn-vue-item
description: >
  shadcn-vue Item component (Vue-Port von shadcn/ui, reka-ui Primitive, CVA, Tailwind v4).
  Triggers: "shadcn-vue item", "item vue", "item list vue", "item group vue", "item komponente vue",
  "item component shadcn", "item media vue", "item actions vue", "item content vue", "item title vue",
  "item description vue", "item footer vue", "item header vue", "item separator vue"
---
