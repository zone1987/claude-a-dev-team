...
- Source code: `RANGE-CALENDAR-SOURCE.md`
- API documentation: `RANGE-CALENDAR-API.md`
- Usage examples: `RANGE-CALENDAR-EXAMPLES.md`
- Installation: `RANGE-CALENDAR-INSTALLATION.md`
