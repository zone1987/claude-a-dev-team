...
- [Basic Usage (from docs)](#basic-usage-from-docs)
- [Simple Date Picker (example with CalendarDate)](#simple-date-picker-example-with-calendardate)
- [Date Picker with Range](#date-picker-with-range)
- [Date Picker with Dropdowns (month/year navigation)](#date-picker-with-dropdowns-monthyear-navigation)
