---
name: shadcn-vue-number-field
description: >
  shadcn-vue NumberField component (Vue-Port von shadcn/ui, reka-ui NumberFieldRoot, Tailwind v4).
  Triggers: "shadcn-vue number-field", "number field vue", "zahlenfeld vue",
  "number field component shadcn", "number input vue", "increment decrement vue",
  "reka-ui number field vue", "stepper input vue", "numeric input vue"
---
