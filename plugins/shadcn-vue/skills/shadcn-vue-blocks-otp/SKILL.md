---
name: shadcn-vue-blocks-otp
description: >
  shadcn-vue OTP-Blocks (otp-01 bis otp-05) — fertige One-Time-Password Seiten mit
  6-stelligem PIN-Input, Resend-Link, Countdown-Timer. Triggers: "shadcn-vue otp block",
  "shadcn vue otp", "otp page vue", "one time password vue", "shadcn otp eingabe",
  "pin eingabe vue", "verifizierungscode vue", "otp input block", "2fa eingabe vue"
---
...
Vollständiger Quellcode aller Blöcke: `references/otp-01-03.md` (otp-01 bis otp-03) und `references/otp-04-05.md` (otp-04, otp-05).
