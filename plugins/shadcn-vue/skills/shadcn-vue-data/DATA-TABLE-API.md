...
- [useVueTable options](#usevuetable-options)
- [State refs](#state-refs)
- [ColumnDef shape](#columndef-shape)
- [table instance methods](#table-instance-methods)
- [Row methods](#row-methods)
- [Column methods](#column-methods)
- [valueUpdater utility](#valueupdater-utility)
- [FlexRender](#flexrender)
- [Cell Formatting example (currency)](#cell-formatting-example-currency)
