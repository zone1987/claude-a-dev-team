...
- [2. Row Actions](#2-row-actions)
- [3. Pagination](#3-pagination)
- [4. Sorting](#4-sorting)
- [5. Filtering](#5-filtering)
- [6. Column Visibility](#6-column-visibility)
- [7. Row Selection](#7-row-selection)
- [8. Expanding](#8-expanding)
- [9. Reusable Column Header](#9-reusable-column-header)
- [10. Reusable Pagination Component](#10-reusable-pagination-component)
- [11. Reusable Column Toggle](#11-reusable-column-toggle)
