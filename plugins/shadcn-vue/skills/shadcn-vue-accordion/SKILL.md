---
name: shadcn-vue-accordion
description: >
  shadcn-vue Accordion component (Vue-Port von shadcn/ui, reka-ui, Tailwind v4, SFC .vue).
  Triggers: "shadcn-vue accordion", "shadcn vue accordion", "accordion vue", "accordion nuxt",
  "accordion reka-ui", "akkordeon vue", "accordion komponente vue",
  "aufklappbare liste vue", "collapsible list vue", "faq accordion vue"
---
...
- `references/api.md` — Props, slots, reka-ui API link
