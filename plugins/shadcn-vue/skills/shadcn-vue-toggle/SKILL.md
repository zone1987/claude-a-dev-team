---
name: shadcn-vue-toggle
description: >
  shadcn-vue Toggle-Komponente (Vue-Port von shadcn/ui, reka-ui ToggleRoot, CVA, Tailwind v4).
  Triggers: "shadcn-vue toggle", "toggle vue", "toggle button vue", "zwei-zustands-schaltfläche vue",
  "toggle varianten vue", "toggle size vue", "reka-ui toggle vue", "toggle on off vue"
---
