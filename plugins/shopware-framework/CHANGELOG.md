...
Restructured from 25 skills into 4 domain skills. **Breaking:** every skill ID changed.

### Why

25 skills cost 11,140 characters of the skill listing budget — 139 % of the 8,000 available at a
...
- **25 skills → 4**, grouped by domain. Listing cost 11,140 → 1,146 characters
  (139 % → 14 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 39 reference files and 6 bundled files remain.
...
Initial release — 25 skills, one per documentation topic.
