...
- [Overview](#overview)
- [Creating Mail Templates (Migration)](#creating-mail-templates-migration)
- [Sending Mails Programmatically](#sending-mails-programmatically)
- [Adding Data to Mail Events](#adding-data-to-mail-events)
- [Flow Builder Integration](#flow-builder-integration)
