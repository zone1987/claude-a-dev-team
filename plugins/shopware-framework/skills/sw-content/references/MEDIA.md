...
- [Overview](#overview)
- [Uploading Media Programmatically](#uploading-media-programmatically)
- [Creating a Media Folder (Migration)](#creating-a-media-folder-migration)
- [Preventing Media Deletion](#preventing-media-deletion)
- [Adding Custom File Extensions](#adding-custom-file-extensions)
