...
- [Concrete Route Implementation](#concrete-route-implementation)
- [Service Registration](#service-registration)
- [Route Registration (routes.xml)](#route-registration-routesxml)
- [Route URL Convention](#route-url-convention)
- [Decorating Existing Routes](#decorating-existing-routes)
- [ApiAware Flag](#apiaware-flag)
