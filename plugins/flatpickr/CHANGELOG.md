...
11 skills cost 5,136 characters of the skill listing budget — 64 % of the 8,000 available at a
...
- **11 skills → 2**, grouped by domain. Listing cost 5,136 → 557 characters
  (64 % → 7 %).
