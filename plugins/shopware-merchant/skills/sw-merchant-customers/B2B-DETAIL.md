...
- [2. Mitarbeiterverwaltung](#2-mitarbeiterverwaltung)
- [3. Rollenverwaltung](#3-rollenverwaltung)
- [4. Frontend-Ansicht (Storefront)](#4-frontend-ansicht-storefront)
- [5. B2B-Features im Überblick (Evolve Plan)](#5-b2b-features-im-überblick-evolve-plan)
- [6. Versionsmatrix](#6-versionsmatrix)
