...
- [1. Was sind Kundengruppen?](#1-was-sind-kundengruppen)
- [2. Kundengruppen-Übersicht](#2-kundengruppen-übersicht)
- [3. Neue Kundengruppe erstellen](#3-neue-kundengruppe-erstellen)
- [4. B2B-Components (Evolve Plan)](#4-b2b-components-evolve-plan)
- [5. Storefront-Registrierungsformular](#5-storefront-registrierungsformular)
- [6. Kunden nach Registrierung verwalten](#6-kunden-nach-registrierung-verwalten)
- [7. Kundengruppe einem Kunden zuweisen](#7-kundengruppe-einem-kunden-zuweisen)
- [8. Versionsmatrix](#8-versionsmatrix)
