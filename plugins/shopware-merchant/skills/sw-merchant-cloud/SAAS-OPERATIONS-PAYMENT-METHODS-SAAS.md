...
- [Zugang](#zugang)
- [Standardmäßig verfügbare Zahlungsarten](#standardmäßig-verfügbare-zahlungsarten)
- [PayPal](#paypal)
- [Zahlungsart dem Verkaufskanal zuordnen](#zahlungsart-dem-verkaufskanal-zuordnen)
- [Zahlungsart konfigurieren](#zahlungsart-konfigurieren)
- [PayPal-Konfiguration (Detaileinstellungen)](#paypal-konfiguration-detaileinstellungen)
