...
- [Überblick der drei Update-Methoden](#überblick-der-drei-update-methoden)
- [Methode 1: Admin-Panel (Schritt-für-Schritt)](#methode-1-admin-panel-schritt-für-schritt)
- [Methode 2: Browser-Installer](#methode-2-browser-installer)
- [Methode 3: Composer + CLI (vollständige Referenz)](#methode-3-composer-cli-vollständige-referenz)
- [Troubleshooting: Erweiterungen lassen sich nicht deaktivieren](#troubleshooting-erweiterungen-lassen-sich-nicht-deaktivieren)
- [Wartungsmodus: Vollständige Referenz](#wartungsmodus-vollständige-referenz)
- [Rollback-Prozess](#rollback-prozess)
