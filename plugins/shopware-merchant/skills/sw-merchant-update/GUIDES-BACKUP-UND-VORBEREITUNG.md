...
- [Backup: Pflichtschritt vor jedem Update](#backup-pflichtschritt-vor-jedem-update)
- [Backup-Methoden](#backup-methoden)
- [Backup-Strategie für Updates](#backup-strategie-für-updates)
- [Erweiterungen: Kompatibilitätsprüfung](#erweiterungen-kompatibilitätsprüfung)
- [Systemvoraussetzungen vor dem Update prüfen](#systemvoraussetzungen-vor-dem-update-prüfen)
- [Screenshots: Update-Prozess](#screenshots-update-prozess)
