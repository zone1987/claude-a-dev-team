...
- [Überblick](#überblick)
- [Admin: Benutzer und Berechtigungen](#admin-benutzer-und-berechtigungen)
- [Sales Agent App: Benutzeroberfläche](#sales-agent-app-benutzeroberfläche)
- [Angebotsverwaltung (Quote Management)](#angebotsverwaltung-quote-management)
- [Integration mit B2B Components](#integration-mit-b2b-components)
