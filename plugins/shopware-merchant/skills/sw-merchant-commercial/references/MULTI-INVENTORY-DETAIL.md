...
- [Lagerhäuser anlegen](#lagerhäuser-anlegen)
- [Lagergruppen (Warehouse Groups)](#lagergruppen-warehouse-groups)
- [Rule Builder Integration](#rule-builder-integration)
- [Bestandsverwaltung je Lager](#bestandsverwaltung-je-lager)
- [Verfügbarkeitslogik](#verfügbarkeitslogik)
