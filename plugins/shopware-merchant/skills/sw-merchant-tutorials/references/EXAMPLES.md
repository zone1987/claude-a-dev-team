# Shopware 6 — Tutorials: Example configurations

Distilled from `https://docs.shopware.com/de/shopware-6-de/tutorials-und-faq/beispiele`.
...
- [1. Dynamic Access — Beispielkonfiguration](#1-dynamic-access-beispielkonfiguration)
- [2. Rabatte und Aktionen — Anwendungsbeispiele](#2-rabatte-und-aktionen-anwendungsbeispiele)
- [3. Rule Builder — Beispielregeln](#3-rule-builder-beispielregeln)
- [4. Flow Builder — Beispielflows](#4-flow-builder-beispielflows)
- [5. Tags — Anwendungsbeispiele](#5-tags-anwendungsbeispiele)
- [6. Advanced Search — Beispiele](#6-advanced-search-beispiele)
