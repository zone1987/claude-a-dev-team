# Shopware 6 — Tutorials: Troubleshooting

Distilled from `https://docs.shopware.com/de/shopware-6-de/tutorials-und-faq/troubleshooting`.
...
- [1. Admin-Passwort zurücksetzen](#1-admin-passwort-zurücksetzen)
- [2. Defekte Erweiterung entfernen](#2-defekte-erweiterung-entfernen)
- [3. Debuggen](#3-debuggen)
- [4. SQL Tipps & Tricks](#4-sql-tipps-tricks)
- [5. Fehlerbehebung im Migrationsprozess](#5-fehlerbehebung-im-migrationsprozess)
- [6. HTML Sanitizer](#6-html-sanitizer)
