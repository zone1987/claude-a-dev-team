# Shopware 6 — Tutorials: General

Distilled from `https://docs.shopware.com/de/shopware-6-de/tutorials-und-faq/allgemeines`.
...
- [1. Berechnung des Warenkorbes](#1-berechnung-des-warenkorbes)
- [2. Hinweise zur APP_URL](#2-hinweise-zur-app_url)
- [3. Flooding-Prävention (Rate Limiting)](#3-flooding-prävention-rate-limiting)
- [4. Message Queue und Scheduled Tasks](#4-message-queue-und-scheduled-tasks)
- [5. Merkzettel (Wunschliste) verwenden](#5-merkzettel-wunschliste-verwenden)
- [6. Performance-Tipps](#6-performance-tipps)
- [7. Onboarding — Dein Shop in einer Stunde](#7-onboarding-dein-shop-in-einer-stunde)
- [8. Produktdarstellung in Kategorien](#8-produktdarstellung-in-kategorien)
- [9. Shopware Konsolenbefehle (CLI)](#9-shopware-konsolenbefehle-cli)
- [10. Umsatzsteuer-ID der Shopkunden](#10-umsatzsteuer-id-der-shopkunden)
- [11. PayPal Plus zu PayPal Checkout migrieren](#11-paypal-plus-zu-paypal-checkout-migrieren)
- [12. Sicherheitsmaßnahmen](#12-sicherheitsmaßnahmen)
- [13. Bugs über GitHub melden](#13-bugs-über-github-melden)
