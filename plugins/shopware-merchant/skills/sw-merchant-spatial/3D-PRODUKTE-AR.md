...
- [2. 3D-Modell an einem Produkt hochladen](#2-3d-modell-an-einem-produkt-hochladen)
- [3. AR-Ansicht konfigurieren](#3-ar-ansicht-konfigurieren)
- [4. Storefront-Darstellung](#4-storefront-darstellung)
- [5. Gerätekompatibilität](#5-gerätekompatibilität)
- [6. 3D-Viewer Block in Erlebniswelten](#6-3d-viewer-block-in-erlebniswelten)
- [7. Technischer Hintergrund: GLB / glTF](#7-technischer-hintergrund-glb-gltf)
- [Quelle](#quelle)
