# Shopware Bild-Editor — KI-gestützte Bildbearbeitung

Verwandelt Produktbilder mit KI: Freistellen, Hintergrundaustausch, Schatten, Neufärbung,
Objektentfernung und Zuschneiden — direkt in der Administration.

**Pfad:** Inhalte > Bild-Editor
...
- [Was ist der Bild-Editor?](#was-ist-der-bild-editor)
- [Mindestvoraussetzungen](#mindestvoraussetzungen)
- [Unterstützte Dateiformate](#unterstützte-dateiformate)
- [Zugang](#zugang)
- [Bearbeitungswerkzeuge (7 Werkzeuge)](#bearbeitungswerkzeuge-7-werkzeuge)
- [Interface-Funktionen](#interface-funktionen)
- [Workflow-Beispiel: Produktbild freistellen und in Hintergrund einbetten](#workflow-beispiel-produktbild-freistellen-und-in-hintergrund-einbetten)
- [Technische Hinweise](#technische-hinweise)
- [Freikontingente & Abonnement](#freikontingente-abonnement)
