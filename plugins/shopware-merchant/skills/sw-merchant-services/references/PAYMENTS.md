...
Integriertes Zahlungssystem auf Basis der **PayPal-Infrastruktur**. Vollständig in die
Administration integriert — ohne externe Systeme oder komplexe Integrationen.

**Verfügbarkeit:** Deutschland und Österreich (EU und USA geplant)
...
- [Was ist Shopware Payments?](#was-ist-shopware-payments)
- [Voraussetzungen](#voraussetzungen)
- [Aktivierung](#aktivierung)
- [Funktionen](#funktionen)
- [Einstellungen](#einstellungen)
- [Übersicht (Dashboard)](#übersicht-dashboard)
- [Bestell-Management](#bestell-management)
- [Migration von PayPal Plugin zu Shopware Payments](#migration-von-paypal-plugin-zu-shopware-payments)
