...
- [1. Domain-Konzept in Shopware 6](#1-domain-konzept-in-shopware-6)
- [2. Domain-Konfiguration: Selbst gehostete Instanz](#2-domain-konfiguration-selbst-gehostete-instanz)
- [3. Domain-Konfiguration: Cloud-Instanz](#3-domain-konfiguration-cloud-instanz)
- [4. Hreflang](#4-hreflang)
- [5. Sprachen zuweisen](#5-sprachen-zuweisen)
- [6. Währungen zuweisen](#6-währungen-zuweisen)
- [Quelle](#quelle)
...
![Domains – Selbst gehostete Instanz](assets/domains-self-hosted.png)
...
![Domain-Konfiguration Detail](assets/domains-detail.png)
...
![Domains – Cloud Instanz](assets/domains-cloud.png)
