...
- [3. Kanal anlegen](#3-kanal-anlegen)
- [4. Konfiguration](#4-konfiguration)
- [5. Reiter: Integration](#5-reiter-integration)
- [6. Reiter: Template](#6-reiter-template)
- [7. Reiter: Statistiken](#7-reiter-statistiken)
- [8. Verfügbarkeit und Einschränkungen](#8-verfügbarkeit-und-einschränkungen)
- [Quelle](#quelle)
