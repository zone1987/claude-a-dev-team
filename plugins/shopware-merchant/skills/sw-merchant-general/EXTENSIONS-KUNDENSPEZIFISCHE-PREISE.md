...
- [Überblick](#überblick)
- [WICHTIG: API-Only-Ansatz](#wichtig-api-only-ansatz)
- [Technische Grundlagen](#technische-grundlagen)
- [API-Endpunkte](#api-endpunkte)
- [Preisdefinition (JSON-Schema)](#preisdefinition-json-schema)
- [Storefront-Verhalten](#storefront-verhalten)
- [Integration mit ERP-Systemen](#integration-mit-erp-systemen)
- [Zugriff auf API-Dokumentation](#zugriff-auf-api-dokumentation)
