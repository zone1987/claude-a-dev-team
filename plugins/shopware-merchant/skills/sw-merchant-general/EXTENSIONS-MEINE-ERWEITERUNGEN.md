...
- [Erweiterung aktivieren / deaktivieren](#erweiterung-aktivieren-deaktivieren)
- [Erweiterung konfigurieren](#erweiterung-konfigurieren)
- [Erweiterung aktualisieren](#erweiterung-aktualisieren)
- [Shopware Account Tab](#shopware-account-tab)
- [Lizenzen verwalten](#lizenzen-verwalten)
- [Pläne und Erweiterungen](#pläne-und-erweiterungen)
