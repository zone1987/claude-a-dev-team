# Shopware 6 – Erweiterungen (Extensions) (Admin)

This skill documents all topics of the "Erweiterungen" chapter of the Shopware 6 merchant documentation.
...
| Social Shopping | `EXTENSIONS-SOCIAL-SHOPPING.md` |
| B2B Suite | `EXTENSIONS-B2B-SUITE.md` |
| Shopware Publisher | `EXTENSIONS-PUBLISHER.md` |
| Digital Sales Rooms | `EXTENSIONS-DIGITAL-SALES-ROOMS.md` |
...
- **Open extensions**: Admin > Erweiterungen > Meine Erweiterungen
- **Open the store**: Admin > Erweiterungen > Store
- **Link the Shopware account**: Erweiterungen > Meine Erweiterungen > Shopware Account tab
- **Plan overview**: https://www.shopware.com/de/preise/

## Plan matrix (short overview)
...
- `sw-merchant-getting-started` – initial setup & account
- `sw-merchant-settings` – system configuration
