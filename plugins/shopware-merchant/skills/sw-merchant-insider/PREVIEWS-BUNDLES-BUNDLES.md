...
- [3. Typische Anwendungsfälle](#3-typische-anwendungsfälle)
- [4. Bundle erstellen – Schritt für Schritt](#4-bundle-erstellen-schritt-für-schritt)
- [5. Darstellung in der Storefront](#5-darstellung-in-der-storefront)
- [6. Weitere Funktionen](#6-weitere-funktionen)
- [7. Screenshots](#7-screenshots)
- [8. Zusammenfassung der Einschränkungen (Blueprint-Phase)](#8-zusammenfassung-der-einschränkungen-blueprint-phase)
- [Quelle](#quelle)
