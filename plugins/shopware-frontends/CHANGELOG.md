...
Restructured from 19 skills into 3 domain skills. **Breaking:** every skill ID changed.

### Why

19 skills cost 9,975 characters of the skill listing budget — 125 % of the 8,000 available at a
...
- **19 skills → 3**, grouped by domain. Listing cost 9,975 → 873 characters
  (125 % → 11 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 38 reference files and 5 bundled files remain.
...
Initial release — 19 skills, one per documentation topic.
