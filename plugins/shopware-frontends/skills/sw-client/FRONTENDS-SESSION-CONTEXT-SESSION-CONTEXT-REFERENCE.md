...
- [Konzept: `sw-context-token`](#konzept-sw-context-token)
- [`useSessionContext` — vollständige API](#usesessioncontext-vollständige-api)
- [Token-Persistenz: Cookie-basiertes Pattern](#token-persistenz-cookie-basiertes-pattern)
- [SSR-sicheres Token-Handling in Nuxt](#ssr-sicheres-token-handling-in-nuxt)
- [Umgebungsvariablen](#umgebungsvariablen)
- [Währung / Sprache wechseln](#währung-sprache-wechseln)
- [Aktueller Kontext-Wert direkt lesen](#aktueller-kontext-wert-direkt-lesen)
- [Pattern: Context nach Login aktualisieren](#pattern-context-nach-login-aktualisieren)
- [Pattern: Sprach-Header für mehrsprachige Shops](#pattern-sprach-header-für-mehrsprachige-shops)
- [`SalesChannelContext` — wichtige Felder](#saleschannelcontext-wichtige-felder)
- [Typische Initialisierungssequenz (vollständig)](#typische-initialisierungssequenz-vollständig)
