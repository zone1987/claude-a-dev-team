...
Restructured from 20 skills into 4 domain skills. **Breaking:** every skill ID changed.

### Why

20 skills cost 8,940 characters of the skill listing budget — 112 % of the 8,000 available at a
...
- **20 skills → 4**, grouped by domain. Listing cost 8,940 → 1,116 characters
  (112 % → 14 %).
- **No knowledge removed.** Every former `SKILL.md` body became a reference file; all reference
  ...
  (`scripts/verify-bundle.py`). 23 reference files and 1 bundled files remain.
...
Initial release — 20 skills, one per documentation topic.
