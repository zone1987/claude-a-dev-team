...
- [Shopware Layout Components (NOT migrated to mt-*)](#shopware-layout-components-not-migrated-to-mt-)
- [Master Mapping Table](#master-mapping-table)
- [1. sw-button to mt-button](#1-sw-button-to-mt-button)
- [2. sw-text-field to mt-text-field](#2-sw-text-field-to-mt-text-field)
- [3. sw-number-field to mt-number-field](#3-sw-number-field-to-mt-number-field)
- [4. sw-select-field to mt-select](#4-sw-select-field-to-mt-select)
- [5. sw-switch-field to mt-switch](#5-sw-switch-field-to-mt-switch)
- [6. sw-checkbox-field to mt-checkbox](#6-sw-checkbox-field-to-mt-checkbox)
- [7. sw-alert to mt-banner](#7-sw-alert-to-mt-banner)
- [8. sw-card to mt-card](#8-sw-card-to-mt-card)
- [9. sw-tabs to mt-tabs](#9-sw-tabs-to-mt-tabs)
- [10. sw-icon to mt-icon](#10-sw-icon-to-mt-icon)
- [11. sw-modal to mt-modal](#11-sw-modal-to-mt-modal)
- [12. sw-loader to mt-loader](#12-sw-loader-to-mt-loader)
- [13. sw-password-field to mt-password-field](#13-sw-password-field-to-mt-password-field)
- [14. sw-email-field to mt-email-field](#14-sw-email-field-to-mt-email-field)
- [15. sw-url-field to mt-url-field](#15-sw-url-field-to-mt-url-field)
- [16. sw-textarea-field to mt-textarea](#16-sw-textarea-field-to-mt-textarea)
- [17. sw-colorpicker to mt-colorpicker](#17-sw-colorpicker-to-mt-colorpicker)
- [18. sw-datepicker to mt-datepicker](#18-sw-datepicker-to-mt-datepicker)
- [19. sw-pagination to mt-pagination](#19-sw-pagination-to-mt-pagination)
- [20. sw-skeleton-bar to mt-skeleton-bar](#20-sw-skeleton-bar-to-mt-skeleton-bar)
- [21. sw-progress-bar to mt-progress-bar](#21-sw-progress-bar-to-mt-progress-bar)
- [22. sw-popover to mt-floating-ui](#22-sw-popover-to-mt-floating-ui)
- [23. sw-data-grid to mt-data-table](#23-sw-data-grid-to-mt-data-table)
- [24. sw-external-link to mt-external-link](#24-sw-external-link-to-mt-external-link)
- [25. sw-text-editor to mt-text-editor](#25-sw-text-editor-to-mt-text-editor)
