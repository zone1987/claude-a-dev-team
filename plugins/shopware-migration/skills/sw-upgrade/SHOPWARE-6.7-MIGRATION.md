...
- [Quick Reference: Task → File](#quick-reference-task-file)
- [How to Use](#how-to-use)
- [Codemod Tool](#codemod-tool)
- [Key Changes at a Glance](#key-changes-at-a-glance)
- [Workflow](#workflow)
- [Searching the Shopware Documentation](#searching-the-shopware-documentation)
...
|------|-----------|------------------|
| sw-* → mt-* component mapping (all 25 components) | `SHOPWARE-6.7-MIGRATION-COMPONENT-MAPPING.md` | — |
| Full page/modal/list migration examples | `SHOPWARE-6.7-MIGRATION-COMPONENT-EXAMPLES.md` | `examples/detail-page-after.html.twig`, `examples/modal-after.html.twig` |
| Webpack → Vite build migration | `SHOPWARE-6.7-MIGRATION-BUILD-SYSTEM-MIGRATION.md` | `examples/vite.config.js` |
| Admin SDK package rename | `SHOPWARE-6.7-MIGRATION-BUILD-SYSTEM-MIGRATION.md` | — |
| Vuex → Pinia state management | `SHOPWARE-6.7-MIGRATION-STATE-MANAGEMENT-MIGRATION.md` | `examples/pinia-store.js` |
| Constructor property promotion | `SHOPWARE-6.7-MIGRATION-PHP-MIGRATION.md` | `examples/constructor-promotion.php` |
| Domain exception factory pattern | `SHOPWARE-6.7-MIGRATION-PHP-MIGRATION.md` | `examples/domain-exception.php` |
| PHP Enums for constants | `SHOPWARE-6.7-MIGRATION-PHP-MIGRATION.md` | — |
| Coding style rules | `SHOPWARE-6.7-MIGRATION-PHP-MIGRATION.md` | `shopware-plugins/examples/coding-style.md` |
| composer.json version constraints | — | `examples/composer-67.json` |
| Composer packages audit & plugin file structure | `SHOPWARE-6.7-MIGRATION-COMPOSER-PACKAGES-AUDIT.md` | `shopware-plugins/examples/composer.json` |
...
2. **Audit composer & files** — follow `SHOPWARE-6.7-MIGRATION-COMPOSER-PACKAGES-AUDIT.md` to verify `require-dev` packages and required plugin root files. Use `shopware-plugins` skill templates for missing files.
...
6. **Review codemod output** — fix TODO comments using `SHOPWARE-6.7-MIGRATION-COMPONENT-MAPPING.md`
7. **Update build system** — follow `SHOPWARE-6.7-MIGRATION-BUILD-SYSTEM-MIGRATION.md`. Delete these obsolete files and clean up empty directories afterward:
...
8. **Migrate state** — follow `SHOPWARE-6.7-MIGRATION-STATE-MANAGEMENT-MIGRATION.md`
9. **Update PHP** — fix remaining issues not covered by Rector, follow `SHOPWARE-6.7-MIGRATION-PHP-MIGRATION.md`
