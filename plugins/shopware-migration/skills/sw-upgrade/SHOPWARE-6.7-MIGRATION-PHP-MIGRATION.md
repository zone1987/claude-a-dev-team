...
- [1. Constructor Property Promotion](#1-constructor-property-promotion)
- [2. Coding Style Requirements](#2-coding-style-requirements)
- [3. Domain Exceptions](#3-domain-exceptions)
- [4. PHP Enums for Constants](#4-php-enums-for-constants)
- [5. Rector Configuration](#5-rector-configuration)
