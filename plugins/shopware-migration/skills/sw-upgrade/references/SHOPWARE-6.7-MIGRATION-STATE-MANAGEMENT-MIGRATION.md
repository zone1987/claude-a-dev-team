...
- [Registering a New Store](#registering-a-new-store)
- [TypeScript Patterns](#typescript-patterns)
- [Subscribing to State Changes](#subscribing-to-state-changes)
- [Unregistering Stores](#unregistering-stores)
- [Migration Checklist](#migration-checklist)
- [Vue 3 Composition API Integration](#vue-3-composition-api-integration)
