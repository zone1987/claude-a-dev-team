...
- [Base Class: Field (abstract)](#base-class-field-abstract)
- [ID & Foreign Key Fields](#id-foreign-key-fields)
- [Scalar / Primitive Fields](#scalar-primitive-fields)
- [Date & Time Fields](#date-time-fields)
- [Specialized String Fields](#specialized-string-fields)
- [JSON-Based Fields](#json-based-fields)
- [Price & Commerce Fields](#price-commerce-fields)
- [Enum & Serialized Fields](#enum-serialized-fields)
- [Auto-Increment & Special Fields](#auto-increment-special-fields)
- [Tree / Hierarchy Fields](#tree-hierarchy-fields)
- [Timestamp Fields](#timestamp-fields)
- [Audit / Tracking Fields](#audit-tracking-fields)
- [Versioning Fields](#versioning-fields)
- [State Machine Field](#state-machine-field)
- [Non-Storage Fields](#non-storage-fields)
- [Extract Priority Order](#extract-priority-order)
