...
- [Overview](#overview)
- [config.xml Structure](#configxml-structure)
- [Available Field Types](#available-field-types)
- [Select Fields with Options](#select-fields-with-options)
- [Reading Configuration in PHP](#reading-configuration-in-php)
- [Configuration Key Pattern](#configuration-key-pattern)
- [Sales Channel-Specific Configuration](#sales-channel-specific-configuration)
- [SystemConfigService Methods](#systemconfigservice-methods)
- [Advanced: Component Override](#advanced-component-override)
