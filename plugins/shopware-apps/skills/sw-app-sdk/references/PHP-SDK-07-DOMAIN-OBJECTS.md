...
- [Delivery / DeliveryPosition / DeliveryDate / CartTransaction / TaxRule](#delivery-deliveryposition-deliverydate-carttransaction-taxrule)
- [Order](#order)
- [OrderTransaction (uses CustomFieldsAware)](#ordertransaction-uses-customfieldsaware)
- [OrderCustomer (uses CustomFieldsAware)](#ordercustomer-uses-customfieldsaware)
- [OrderLineItem (extends LineItem)](#orderlineitem-extends-lineitem)
- [SalesChannelContext](#saleschannelcontext)
- [PaymentMethod](#paymentmethod)
- [ShippingMethod](#shippingmethod)
- [Currency (uses CustomFieldsAware)](#currency-uses-customfieldsaware)
- [Address (uses CustomFieldsAware)](#address-uses-customfieldsaware)
- [Country / CountryState / TaxInfo](#country-countrystate-taxinfo)
- [SalesChannel / SalesChannelDomain / LanguageInfo / RoundingConfig / ShippingLocation](#saleschannel-saleschanneldomain-languageinfo-roundingconfig-shippinglocation)
- [Customer (SalesChannelContext, uses CustomFieldsAware)](#customer-saleschannelcontext-uses-customfieldsaware)
- [Refund / RefundTransactionCapture (both use CustomFieldsAware)](#refund-refundtransactioncapture-both-use-customfieldsaware)
