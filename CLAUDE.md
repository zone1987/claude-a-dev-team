...
operations — 1,787 rendered field entries across 7,736 lines — and spends 2,392 characters,
...
grep -rhoE '^- \*\*[A-Za-z_][A-Za-z0-9_]*\*\* \(' plugins/octo-api/skills | wc -l   # 1,787 fields
